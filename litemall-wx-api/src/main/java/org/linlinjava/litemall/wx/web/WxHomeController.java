...
public class WxHomeController {
     ...
     */
    @GetMapping("/index")
    public Object index(@LoginUser Integer userId,@RequestParam(defaultValue = "0") Integer page,@RequestParam(defaultValue = "10") Integer size) {
        //优先从缓存中读取
...
*/
        ...
        Callable<List> goodsListCallable = () -> goodsService.queryByPageNum(page, size);//SystemConfig.getNewLimit());
...
/*        FutureTask<List> hotGoodsListTask = new FutureTask<>(hotGoodsListCallable);
        ...
        try {
            ...
            List goodsList = goodsListTask.get();
            long total = PageInfo.of(goodsList).getTotal();
            data.put("goodsList", goodsList);
            data.put("page",PageInfo.of(goodsList).getPageNum());
